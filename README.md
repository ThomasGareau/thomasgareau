...
<head>
    ...
    <style>
        /* Custom styles to further reduce spacing */
        body > nav {
            margin-bottom: 0; /* Reduces the bottom margin of the nav */
        }
        nav h1, main h2, main h3 {
            margin: 0; /* Removes the default margin from h1, h2, and h3 tags */
            padding: 0; /* Removes the default padding from h1, h2, and h3 tags */
        }
        main h2 {
            margin-top: 8px !important; /* Adds a tiny top margin to h2 tag and ensures it overrides the Pico CSS */
        }
        main.container {
            padding-top: 8px !important; /* Reduces the top padding of the main container */
        }

        /* Overriding Dark Mode Styles */
        @media (prefers-color-scheme: dark) {
            body {
                background-color: #fff; /* Setting background to white */
                color: #333; /* Setting text color to a darker shade for better visibility */
            }
            /* Ensuring all text is visible */
            h1, h2, h3, p, a, nav, main {
                color: #333; /* Setting text color to a darker shade for better visibility */
            }
        }
    </style>
    <title>Thomas Gareau-Paquette - Political Science Master's Student</title>
</head>
<body>
    <nav class="container-fluid">
        <h1>Thomas Gareau-Paquette</h1>
    </nav>
<br>
...
<p>Welcome to my website! Currently pursuing a <strong>Master's degree in Political Science</strong> at <strong>McGill University</strong> as an Eren Graduate Fellow, I am an incoming PhD student at <strong>Cornell University's Department of Government</strong>. 
<p>
